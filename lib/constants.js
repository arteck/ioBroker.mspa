...
const STATE_DEFS = {
    ...
    'status.heat_state':        { role: 'value',                type: 'number',  read: true,  write: false, def: 0,      name: 'Heat state (0=off,2=preheat,3=heating,4=idle)' },
    ...
    'status.filter_current':    { role: 'value',                type: 'number',  read: true,  write: false, def: 0,      name: 'Filter current (h)' },
    'status.filter_life':       { role: 'value',                type: 'number',  read: true,  write: false, def: 0,      name: 'Filter life remaining (h)' },
    'status.temperature_unit':  { role: 'value',                type: 'number',  read: true,  write: false, def: 0,      name: 'Temperature unit (0=°C, 1=°F)' },
    'status.safety_lock':       { role: 'value',                type: 'number',  read: true,  write: false, def: 0,      name: 'Safety lock' },
    'status.heat_time':         { role: 'value',                type: 'number',  read: true,  write: false, def: 0,      name: 'Heat time (min)' },
